...
public class StartRemotePeers {
	...
	private static final String scriptPrefix = "cd 5106 && java peerProcess ";
	...
	public static class PeerInfo {
		...
		public PeerInfo(int peerID, String hostName) {
			super();
	...
	public static void main(String[] args) {
		...
		String ciseUser = "ww2"; // change with your CISE username
		...
		*/
		...
		for (config.PeerInfo peerInfo : peerInfoConfig.getPeers())
			peerList.add(new PeerInfo(peerInfo.getId(), peerInfo.getHostName()));
